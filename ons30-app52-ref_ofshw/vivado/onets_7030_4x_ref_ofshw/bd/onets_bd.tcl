...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_interc_gp_M05_AXI [get_bd_intf_pins axi_interc_gp/M05_AXI] [get_bd_intf_pins ref_openflow_core_0/s_axi_lite]
  ...
  connect_bd_intf_net -intf_net s_axis_txc_1 [get_bd_intf_pins axi_ethernet_0/s_axis_txc] [get_bd_intf_pins ref_openflow_core_0/m_axis_txc_0]
  connect_bd_intf_net -intf_net s_axis_txc_2 [get_bd_intf_pins axi_ethernet_1/s_axis_txc] [get_bd_intf_pins ref_openflow_core_0/m_axis_txc_1]
  connect_bd_intf_net -intf_net s_axis_txc_3 [get_bd_intf_pins axi_ethernet_2/s_axis_txc] [get_bd_intf_pins ref_openflow_core_0/m_axis_txc_2]
  connect_bd_intf_net -intf_net s_axis_txc_4 [get_bd_intf_pins axi_ethernet_3/s_axis_txc] [get_bd_intf_pins ref_openflow_core_0/m_axis_txc_3]
  connect_bd_intf_net -intf_net s_axis_txd_1 [get_bd_intf_pins axi_ethernet_0/s_axis_txd] [get_bd_intf_pins ref_openflow_core_0/m_axis_txd_0]
  connect_bd_intf_net -intf_net s_axis_txd_2 [get_bd_intf_pins axi_ethernet_1/s_axis_txd] [get_bd_intf_pins ref_openflow_core_0/m_axis_txd_1]
  connect_bd_intf_net -intf_net s_axis_txd_3 [get_bd_intf_pins axi_ethernet_3/s_axis_txd] [get_bd_intf_pins ref_openflow_core_0/m_axis_txd_3]
  ...
  connect_bd_net -net axi_dma_0_mm2s_prmry_reset_out_n [get_bd_pins axi_dma_0/mm2s_prmry_reset_out_n] [get_bd_pins axi_ethernet_0/axi_txd_arstn] [get_bd_pins axi_ethernet_2/axi_rxd_arstn] [get_bd_pins axi_ethernet_2/axi_rxs_arstn] [get_bd_pins axi_ethernet_2/axi_txc_arstn] [get_bd_pins axi_ethernet_2/axi_txd_arstn]
