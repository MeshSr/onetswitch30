...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.NUM_MI {9}  ] $axi_interc_gp
  ...
  connect_bd_intf_net -intf_net axi_interc_gp_M08_AXI [get_bd_intf_pins axi_interc_gp/M08_AXI] [get_bd_intf_pins packet_pipeline_0/s_axi_lite]
  ...
  connect_bd_intf_net -intf_net s_axis_txc_1 [get_bd_intf_pins axi_ethernet_3/s_axis_txc] [get_bd_intf_pins packet_pipeline_0/m_axis_txc_3]
  connect_bd_intf_net -intf_net s_axis_txc_2 [get_bd_intf_pins axi_ethernet_0/s_axis_txc] [get_bd_intf_pins packet_pipeline_0/m_axis_txc_0]
  connect_bd_intf_net -intf_net s_axis_txd_1 [get_bd_intf_pins axi_ethernet_2/s_axis_txd] [get_bd_intf_pins packet_pipeline_0/m_axis_txd_2]
  connect_bd_intf_net -intf_net s_axis_txd_2 [get_bd_intf_pins axi_ethernet_1/s_axis_txd] [get_bd_intf_pins packet_pipeline_0/m_axis_txd_1]
