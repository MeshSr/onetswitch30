...
`timescale 1ns/1ps
  module queue_aggr
   ...
   // ------------- Regs/ wires -----------
   wire [MAX_NUM_QUEUES-1:0]           nearly_full;
   wire [MAX_NUM_QUEUES-1:0]           empty;
   wire [DATA_WIDTH-1:0]               in_data      [MAX_NUM_QUEUES-1:0];
   wire [CTRL_WIDTH-1:0]               in_ctrl      [MAX_NUM_QUEUES-1:0];
   wire [MAX_NUM_QUEUES-1:0]           in_wr;
   wire [CTRL_WIDTH-1:0]               fifo_out_ctrl[MAX_NUM_QUEUES-1:0];
   wire [DATA_WIDTH-1:0]               fifo_out_data[MAX_NUM_QUEUES-1:0];
   reg [MAX_NUM_QUEUES-1:0]            rd_en;
