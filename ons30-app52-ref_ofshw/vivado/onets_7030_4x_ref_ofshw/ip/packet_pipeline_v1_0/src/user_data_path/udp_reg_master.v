...
module udp_reg_master
   ...
   (
      ...
      output   [31:0]                    data_output_port_lookup_0_o ,
      ...
      output   [31:0]                    addr_output_port_lookup_0_o ,
   ...
   assign data_output_port_lookup_0_o  =  reg_data_in ;
   ...
   assign addr_output_port_lookup_0_o  =  reg_addr_in ;
   ...
   assign req_output_port_lookup_0_o      =  (reg_addr_in[`MODULE_ID_POS+`MODULE_ID_WIDTH-1:`MODULE_ID_POS]==`OUTPUT_PORT_LOOKUP_TAG && reg_addr_in[`TABLE_ID_POS+`TABLE_ID_WIDTH-1:`TABLE_ID_POS]==0) ? reg_req_in : 0;
   ...
   assign rw_output_port_lookup_0_o       =  reg_rd_wr_L_in;
   ...
   if(reset)
      ...
      0:if(req_output_port_lookup_0_o | req_output_port_lookup_1_o | req_output_port_lookup_2_o | req_meter_o | req_output_queues_o) ack_state<=1;
        else if(reg_req_in) ack_state<=3;
      1:if(ack_output_port_lookup_0_i | ack_output_port_lookup_1_i | ack_output_port_lookup_2_i | ack_meter_i | ack_output_queues_i) ack_state<=2;
      2:ack_state<=0;
      3:ack_state<=0;
      default:ack_state<=0;
      endcase
   ...
   begin
      if(ack_output_port_lookup_0_i)      reg_rd_data <= data_output_port_lookup_0_i;
