...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.NUM_MI {8}  ] $axi_interc_gp
  ...
  set_property -dict [ list CONFIG.NUM_MI {1} CONFIG.NUM_SI {12}  ] $axi_interc_hp
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins axi_dma_1/M_AXI_MM2S] [get_bd_intf_pins axi_interc_hp/S04_AXI]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_S2MM [get_bd_intf_pins axi_dma_1/M_AXI_S2MM] [get_bd_intf_pins axi_interc_hp/S05_AXI]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_SG [get_bd_intf_pins axi_dma_1/M_AXI_SG] [get_bd_intf_pins axi_interc_hp/S03_AXI]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_MM2S [get_bd_intf_pins axi_dma_2/M_AXI_MM2S] [get_bd_intf_pins axi_interc_hp/S07_AXI]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_S2MM [get_bd_intf_pins axi_dma_2/M_AXI_S2MM] [get_bd_intf_pins axi_interc_hp/S08_AXI]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_SG [get_bd_intf_pins axi_dma_2/M_AXI_SG] [get_bd_intf_pins axi_interc_hp/S06_AXI]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXI_MM2S [get_bd_intf_pins axi_dma_3/M_AXI_MM2S] [get_bd_intf_pins axi_interc_hp/S10_AXI]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXI_S2MM [get_bd_intf_pins axi_dma_3/M_AXI_S2MM] [get_bd_intf_pins axi_interc_hp/S11_AXI]
  connect_bd_intf_net -intf_net axi_dma_3_M_AXI_SG [get_bd_intf_pins axi_dma_3/M_AXI_SG] [get_bd_intf_pins axi_interc_hp/S09_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interc_gp_M05_AXI [get_bd_intf_pins axi_dma_1/S_AXI_LITE] [get_bd_intf_pins axi_interc_gp/M05_AXI]
  connect_bd_intf_net -intf_net axi_interc_gp_M06_AXI [get_bd_intf_pins axi_dma_2/S_AXI_LITE] [get_bd_intf_pins axi_interc_gp/M06_AXI]
  connect_bd_intf_net -intf_net axi_interc_gp_M07_AXI [get_bd_intf_pins axi_dma_3/S_AXI_LITE] [get_bd_intf_pins axi_interc_gp/M07_AXI]
  ...
  connect_bd_intf_net -intf_net s_axis_txc_1 [get_bd_intf_pins axi_dma_0/M_AXIS_CNTRL] [get_bd_intf_pins axi_ethernet_0/s_axis_txc]
  connect_bd_intf_net -intf_net s_axis_txc_2 [get_bd_intf_pins axi_dma_1/M_AXIS_CNTRL] [get_bd_intf_pins axi_ethernet_1/s_axis_txc]
  connect_bd_intf_net -intf_net s_axis_txc_3 [get_bd_intf_pins axi_dma_2/M_AXIS_CNTRL] [get_bd_intf_pins axi_ethernet_2/s_axis_txc]
  connect_bd_intf_net -intf_net s_axis_txc_4 [get_bd_intf_pins axi_dma_3/M_AXIS_CNTRL] [get_bd_intf_pins axi_ethernet_3/s_axis_txc]
  connect_bd_intf_net -intf_net s_axis_txd_1 [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axi_ethernet_0/s_axis_txd]
  connect_bd_intf_net -intf_net s_axis_txd_2 [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins axi_ethernet_1/s_axis_txd]
  connect_bd_intf_net -intf_net s_axis_txd_3 [get_bd_intf_pins axi_dma_2/M_AXIS_MM2S] [get_bd_intf_pins axi_ethernet_2/s_axis_txd]
  connect_bd_intf_net -intf_net s_axis_txd_4 [get_bd_intf_pins axi_dma_3/M_AXIS_MM2S] [get_bd_intf_pins axi_ethernet_3/s_axis_txd]
  ...
  connect_bd_net -net axi_dma_1_mm2s_introut [get_bd_pins axi_dma_1/mm2s_introut] [get_bd_pins xlconcat_0/In6]
  ...
  connect_bd_net -net axi_dma_1_s2mm_introut [get_bd_pins axi_dma_1/s2mm_introut] [get_bd_pins xlconcat_0/In7]
  ...
  connect_bd_net -net const_vcc_const [get_bd_pins axi_ethernet_0/signal_detect] [get_bd_pins axi_ethernet_1/mdio_mdio_i] [get_bd_pins axi_ethernet_1/mmcm_locked] [get_bd_pins axi_ethernet_1/signal_detect] [get_bd_pins axi_ethernet_2/mdio_mdio_i] [get_bd_pins axi_ethernet_2/mmcm_locked] [get_bd_pins axi_ethernet_2/signal_detect] [get_bd_pins axi_ethernet_3/mdio_mdio_i] [get_bd_pins axi_ethernet_3/mmcm_locked] [get_bd_pins axi_ethernet_3/signal_detect] [get_bd_pins const_vcc/const] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net ext_reset_in_1 [get_bd_ports ext_rst] [get_bd_pins proc_sys_reset_0/ext_reset_in]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_ports bd_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins axi_dma_3/axi_resetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_1/s_axi_lite_resetn] [get_bd_pins axi_ethernet_2/s_axi_lite_resetn] [get_bd_pins axi_ethernet_3/s_axi_lite_resetn] [get_bd_pins axi_interc_gp/ARESETN] [get_bd_pins axi_interc_gp/M00_ARESETN] [get_bd_pins axi_interc_gp/M01_ARESETN] [get_bd_pins axi_interc_gp/M02_ARESETN] [get_bd_pins axi_interc_gp/M03_ARESETN] [get_bd_pins axi_interc_gp/M04_ARESETN] [get_bd_pins axi_interc_gp/M05_ARESETN] [get_bd_pins axi_interc_gp/M06_ARESETN] [get_bd_pins axi_interc_gp/M07_ARESETN] [get_bd_pins axi_interc_gp/S00_ARESETN] [get_bd_pins axi_interc_hp/ARESETN] [get_bd_pins axi_interc_hp/M00_ARESETN] [get_bd_pins axi_interc_hp/S00_ARESETN] [get_bd_pins axi_interc_hp/S01_ARESETN] [get_bd_pins axi_interc_hp/S02_ARESETN] [get_bd_pins axi_interc_hp/S03_ARESETN] [get_bd_pins axi_interc_hp/S04_ARESETN] [get_bd_pins axi_interc_hp/S05_ARESETN] [get_bd_pins axi_interc_hp/S06_ARESETN] [get_bd_pins axi_interc_hp/S07_ARESETN] [get_bd_pins axi_interc_hp/S08_ARESETN] [get_bd_pins axi_interc_hp/S09_ARESETN] [get_bd_pins axi_interc_hp/S10_ARESETN] [get_bd_pins axi_interc_hp/S11_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports bd_fclk0_125m] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/m_axi_sg_aclk] [get_bd_pins axi_dma_2/m_axi_mm2s_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/m_axi_sg_aclk] [get_bd_pins axi_dma_3/m_axi_mm2s_aclk] [get_bd_pins axi_dma_3/m_axi_s2mm_aclk] [get_bd_pins axi_dma_3/m_axi_sg_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_1/axis_clk] [get_bd_pins axi_ethernet_2/axis_clk] [get_bd_pins axi_ethernet_3/axis_clk] [get_bd_pins axi_interc_hp/ACLK] [get_bd_pins axi_interc_hp/M00_ACLK] [get_bd_pins axi_interc_hp/S00_ACLK] [get_bd_pins axi_interc_hp/S01_ACLK] [get_bd_pins axi_interc_hp/S02_ACLK] [get_bd_pins axi_interc_hp/S03_ACLK] [get_bd_pins axi_interc_hp/S04_ACLK] [get_bd_pins axi_interc_hp/S05_ACLK] [get_bd_pins axi_interc_hp/S06_ACLK] [get_bd_pins axi_interc_hp/S07_ACLK] [get_bd_pins axi_interc_hp/S08_ACLK] [get_bd_pins axi_interc_hp/S09_ACLK] [get_bd_pins axi_interc_hp/S10_ACLK] [get_bd_pins axi_interc_hp/S11_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports bd_fclk1_75m] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_dma_3/s_axi_lite_aclk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_1/s_axi_lite_clk] [get_bd_pins axi_ethernet_2/s_axi_lite_clk] [get_bd_pins axi_ethernet_3/s_axi_lite_clk] [get_bd_pins axi_interc_gp/ACLK] [get_bd_pins axi_interc_gp/M00_ACLK] [get_bd_pins axi_interc_gp/M01_ACLK] [get_bd_pins axi_interc_gp/M02_ACLK] [get_bd_pins axi_interc_gp/M03_ACLK] [get_bd_pins axi_interc_gp/M04_ACLK] [get_bd_pins axi_interc_gp/M05_ACLK] [get_bd_pins axi_interc_gp/M06_ACLK] [get_bd_pins axi_interc_gp/M07_ACLK] [get_bd_pins axi_interc_gp/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
